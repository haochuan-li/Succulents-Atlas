...
public class CatalogActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = removeRepeatDriver(ConstantList.getAllBotany());
        Log.e("!!!!", mList.toString());
        recyclerview = findViewById(R.id.recyclerview);
        //设置布局管理器
        recyclerview.setLayoutManager(new WrapContentLinearLayoutManager(CatalogActivity.this, 3));
        ...
        adapter.setOnItemClickListener(new MyRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(CatalogActivity.this, SpeciesActivity.class);
                intent.putExtra("family", mList.get(position).getFamily());
                intent.putExtra("type", "botany");
